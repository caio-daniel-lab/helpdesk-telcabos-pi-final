...
public class ChamadoService {
    ...
    public Chamado abrirChamado(String vendedor, String cidade, String departamento,
        ...
        // Regra de negócio: calcular prioridade
        String prioridade = calcularPrioridade(tipoProblema);
    ...
    /**
     * REGRA DE NEGÓCIO: determina a prioridade com base no tipo de problema.
     *
     * Refatoração: estava duplicada na TelaNovoChamado. Centralizada aqui.
     */
    private String calcularPrioridade(String tipoProblema) {
        if (tipoProblema == null) return "Media";
        if (tipoProblema.contains("Autcom") || tipoProblema.contains("Computador")) {
            return "Alta";
        }
        return "Media";
    }
